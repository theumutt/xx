...
local Pendulum = Library.CreateLib("Monopoly Hub 1.0")
local UserInputService = game:GetService("UserInputService")

local ScriptsTab = Pendulum:NewTab("Scripts",true)
local CreditsTab = Pendulum:NewTab("Credits",false)
...
CreditsTab:NewLabel("Credits to semih#1000 for making the entire hub")
CreditsTab:NewLabel("Pendulum hubs very own UI was made by semih#1000")
